...
import { createVendorsForArea, type VendorsForArea } from "./agentkit/vendors.js";
...
export class AgoraClient<TArea extends AgoraArea = AgoraArea> extends BaseAgoraClient {
    ...
    public readonly vendors: VendorsForArea<TArea>;
    ...
    constructor(options: AgoraClient.Options<TArea>) {
        ...
        this.vendors = createVendorsForArea(this.area);
    }
